...
All public URLs live in **`src/lib/project-meta.ts`**. The repository and
public-preview URLs are configured there. Footer links, settings, Trust
Center, and launch copy all read from this file.
